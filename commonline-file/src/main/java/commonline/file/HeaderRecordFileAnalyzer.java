...
public class HeaderRecordFileAnalyzer implements FileAnalyzer {
    ...
    public HeaderRecordFileAnalyzer() {
        this(new CommonlineHeaderLocator());
    }

    protected HeaderRecordFileAnalyzer(HeaderLocator headerLocator) {
