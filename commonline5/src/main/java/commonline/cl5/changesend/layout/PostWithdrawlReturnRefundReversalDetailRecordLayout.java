...
public class PostWithdrawlReturnRefundReversalDetailRecordLayout extends AbstractCommonLineRecordLayout {
    public PostWithdrawlReturnRefundReversalDetailRecordLayout() {
        super("@129");
    }
    ...
    protected void defineFields() {
        ...
        field("26", "Filler", "X(2)");
        field("27", "Previously Reported Return to Lender Date", "9(8)");
        field("28", "Previously Reported Return to Lender Amount", "9(6)v99");
        field("29", "Disbursement Date (CCYYMMDD)", "X(8)");
        field("30", "Disbursement Amount", "X(8)");
        field("31", "Filler", "X(2)");
        field("32", "Previously Reported Return to Lender Date", "X(8)");
        field("33", "Previously Reported Return to Lender Amount", "X(8)");
        field("34", "Disbursement Date (CCYYMMDD)", "X(8)");
        field("35", "Disbursement Amount", "X(8)");
        field("36", "Filler", "X(2)");
        field("37", "Previously Reported Return to Lender Date", "X(8)");
        field("38", "Previously Reported Return to Lender Amount", "X(8)");
        field("39", "Disbursement Date (CCYYMMDD)", "X(8)");
        field("40", "Disbursement Amount", "X(8)");
        field("41", "Filler", "X(2)");
        field("42", "Previously Reported Return to Lender Date", "X(8)");
        field("43", "Previously Reported Return to Lender Amount", "X(8)");
        field("44", "Net Amount Disbursed to Date", "X(8)");
        field("45", "Filler", "X(23)");
        field("46", "Disbursement Identification Number", "9(2)");
        field("47", "Disbursement Identification Number", "X(2)");
        field("48", "Disbursement Identification Number", "X(2)");
        field("49", "Disbursement Identification Number", "X(2)");
        field("50", "Filler", "9(19)");
        ...
        field("57", "Filler", "X(9)");
        field("58", "Filler", "X(9)");
        field("59", "Lender Non-ED Branch ID", "X(4)");
        field("60", "Filler", "X(18)");
        field("61", "Record Status", "X(1)");
        field("62", "Date/Time Stamp (CCYYMMDDHHMMSSNNNNNN)", "9(20)");
        recordTerminator("63");
    }
}
