...
public class LoanPeriodGradeLevelAnticipatedCompletionDateChangedRecordLayout extends AbstractCommonLineRecordLayout {
    public LoanPeriodGradeLevelAnticipatedCompletionDateChangedRecordLayout() {
        super("@107");
    }
