...
public class AlternativeLoanDetailRecordLayout extends AbstractCommonLineRecordLayout {
    ...
    protected void defineFields() {
        ...
        field("4", "Federal Stafford Loan Debt", "X(5)");
        field("5", "Federal SLS Debt", "X(5)");
        field("6", "HEAL Debt", "X(6)");
        field("7", "Perkins Debt", "X(5)");
        field("8", "Other Debt", "X(6)");
        field("9", "Other Loans this Period", "X(7)");
        ...
        field("57", "Filler", "X(3)");
        field("58", "Cosigner 1 Years at Address", "X(2)");
        field("59", "Cosigner 2 Relationship to Student", "X(1)");
        field("60", "Filler", "X(3)");
        field("61", "Cosigner 2 Years at Address", "X(2)");
        field("62", "Interest Rate Option", "X(1)");
        field("63", "Repayment Option Code", "X(1)");
        field("64", "Cosigner 1 Foreign Telephone Number Prefix", "X(10)");
        field("65", "Cosigner 2 Foreign Telephone Number Prefix", "X(10)");
        field("66", "Student Monthly Housing Payment", "X(5)");
        field("67", "Student Monthly Credit Card Payment", "X(5)");
        field("68", "Student Monthly Auto Payment", "X(5)");
        field("69", "Student Monthly Educational Loan Payment", "X(5)");
        field("70", "Student Monthly Other Payment", "X(5)");
        field("71", "Cosigner 1 Monthly Housing Payment", "X(5)");
        field("72", "Cosigner 1 Monthly Credit Card Payment", "X(5)");
        field("73", "Cosigner 1 Monthly Auto Payment", "X(5)");
        field("74", "Cosigner 1 Monthly Educational Loan Payment", "X(5)");
        field("75", "Cosigner 1 Monthly Other Payment", "X(5)");
        field("76", "Cosigner 2 Monthly Housing Payment", "X(5)");
        field("77", "Cosigner 2 Monthly Credit Card Payment", "X(5)");
        field("78", "Cosigner 2 Monthly Auto Payment", "X(5)");
        field("79", "Cosigner 2 Monthly Educational Loan Payment", "X(5)");
        field("80", "Cosigner 2 Monthly Other Payment", "X(5)");
        field("81", "Cosigner 1 Credit Authorization Code", "X(1)");
        field("82", "Cosigner 2 Credit Authorization Code", "X(1)");
        field("83", "Cosigner 1 Electronic Signature Indicator Code", "X(1)");
        field("84", "Cosigner 2 Electronic Signature Indicator Code", "X(1)");
        field("85", "Filler", "X(288)");
        recordTerminator("86");
    }
}
