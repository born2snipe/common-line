...
public class AppSendParser extends AbstractCommonLineRecordParser {
    protected void initializeRecordLayouts(List recordLayouts) {
        ...
        recordLayouts.add(new AlternativeLoanDetailRecordLayout());
        recordLayouts.add(new ApplicationSendDetailRecordLayout());
        recordLayouts.add(new ReferenceDetailRecordLayout());
        recordLayouts.add(new SupplementalBorrowerInformationRecordLayout());
        recordLayouts.add(new SupplementalDisbursementSendDetailRecordLayout());
