...
public class SubUnsubReallocationLoanDecreaseRecordLayoutTest extends AbstractRecordLayoutTestCase {
    protected RecordLayout createRecordLayout() {
        return new SubUnsubReallocationLoanDecreaseRecordLayout();
    }
    ...
    public void test_fieldDefinitions() {
        ...
        assertText("28", "Estimated Financial Aid Amount", 161, 5);
