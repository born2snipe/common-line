...
public class SubUnsubReallocationLoanIncreaseRecordLayoutTest extends AbstractRecordLayoutTestCase {
    protected RecordLayout createRecordLayout() {
        return new SubUnsubReallocationLoanIncreaseRecordLayout();
    }
    ...
    public void test_fieldDefinitions() {
        ...
        assertText("55", "Record Status", 459, 1);
