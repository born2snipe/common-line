 ...
 * <p/>
 * Reference (@5) Detail Record(s) Addendum
 */
public class ReferenceDetailRecordLayout extends AbstractCommonLineRecordLayout {
    ...
    protected void defineFields() {
        field("2", "Reference Layout Owner Code", "X(4)");
        field("3", "Reference Layout Identifier Code", "X(2)");
        ...
        field("30", "Borrower Employer Name", "X(20)");
        field("31", "Borrower Employer Address (line 1)", "X(30)");
        field("32", "Borrower Employer Address (line 2)", "X(30)");
        field("33", "Borrower Employer City", "X(24)");
        field("34", "Filler", "X(6)");
        field("35", "Borrower Employer State", "X(2)");
        field("36", "Borrower Employer Zip Code", "9(5)");
        field("37", "Borrower Employer Zip Code Suffix", "9(4)");
        field("38", "Borrower/Cosigner Borrower Employer Telephone Number", "X(10)");
        field("39", "Reference 1 Foreign Postal Code", "X(14)");
        field("40", "Reference 2 Foreign Postal Code", "X(14)");
        field("41", "Borrower/Cosigner Credit Information Indicator", "X(1)");
        field("42", "Borrower/Cosigner Monthly Housing Payment", "9(5)");
        ...
        field("50", "Borrower/Cosigner Self- employed Indicator", "X(1)");
        field("51", "Borrower/Cosigner Employer/Company Name", "X(30)");
        field("52", "Borrower/Cosigner Position Description", "X(26)");
        field("53", "Borrower/Cosigner Years at Employer", "9(2)");
        field("54", "Filler", "X(5)");
        field("55", "Borrower/Cosigner Previous Employer", "X(30)");
        field("56", "Borrower/Cosigner Previous Position Description", "X(30)");
        field("57", "Borrower/Cosigner Previous Employer Phone", "X(10)");
        field("58", "Filler", "X(5)");
        field("59", "Borrower/Cosigner Source of Other Income", "X(15)");
        field("60", "Filler", "X(120)");
        recordTerminator("61");
    }
