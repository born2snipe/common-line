...
public class SchoolRefundRecordLayout extends AbstractCommonLineRecordLayout {
    public SchoolRefundRecordLayout() {
        super("@111");
    }
    ...
    protected void defineFields() {
        ...
        field("23", "School Refund Date(CCYYMMDD)", "9(8)");
        field("24", "School Refund Amount", "9(6)V99");
        field("25", "Net Loan Amount", "9(6)V99");
        field("26", "Withdrawal Date (CCYYMMDD)", "9(8)");
        field("27", "Funds Return Method Code", "X(1)");
        field("28", "Record Status", "X(1)");
        field("29", "Date/Time Stamp(CCYYMMDDHHMMSSNNNNNN)", "X(20)");
        field("30", "DUNS School ID", "X(9)");
        field("31", "DUNS Recipient ID", "X(9)");
        field("32", "DUNS Lender ID", "X(9)");
        field("33", "DUNS Servicer Code", "X(9)");
        field("34", "Filler", "X(185)");
        field("35", "School Use Only", "X(23)");
